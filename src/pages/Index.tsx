...
const Index = () => {
  ...
  return (
      ...
      {/* Services Section */}
      <section id="services" className="py-24 bg-surface/50 relative overflow-hidden">
        {/* Cybersecurity Services Background Animation */}
        <div className="absolute inset-0 pointer-events-none">
          {/* Central Shield with Padlock */}
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-0">
            <div className={`relative w-32 h-40 transition-colors duration-500 ${
              theme === 'light' ? 'text-cyber-blue/90' : 'text-cyber-blue/40'
            }`}>
              {/* Shield Background */}
              <div className={`absolute inset-0 bg-gradient-to-b from-cyber-blue/20 to-cyber-blue/5 rounded-t-full border-2 transition-colors duration-500 ${
                theme === 'light' ? 'border-cyber-blue/80' : 'border-cyber-blue/30'
              }`}></div>
              {/* Shield Shape */}
              <div className={`absolute inset-0 bg-gradient-to-b from-cyber-blue/10 to-transparent rounded-t-full transition-colors duration-500 ${
                theme === 'light' ? 'shadow-[0_0_30px_rgba(59,130,246,0.6)]' : 'shadow-[0_0_20px_rgba(59,130,246,0.3)]'
              }`}></div>
              {/* Padlock Icon */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <Lock className="w-16 h-16 animate-pulse-slow" />
              </div>
            </div>
          </div>
          ...
          <div className="absolute inset-0">
            {/* Primary Network Ring */}
            <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 border rounded-full animate-spin-slow transition-colors duration-500 ${
              theme === 'light' ? 'border-cyber-blue/60' : 'border-cyber-blue/20'
            }`}></div>
            {/* Secondary Network Ring */}
            <div className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 border rounded-full animate-spin-medium transition-colors duration-500 ${
              theme === 'light' ? 'border-cyber-blue/70' : 'border-cyber-blue/25'
            }`}></div>
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80">
              {[...Array(8)].map((_, i) => (
                <div
                  key={i}
                  className={`absolute top-1/2 left-1/2 w-1 h-20 bg-gradient-to-b from-cyber-blue to-transparent transform transition-colors duration-500 ${
                    theme === 'light' ? 'opacity-80' : 'opacity-40'
                  }`}
                  style={{
          ...
          <div className="absolute inset-0">
            {/* Folder Icon */}
            <div className="absolute top-20 left-20 animate-float-slow">
              <FileText className={`w-8 h-8 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/85' : 'text-cyber-blue/35'
              }`} />
            </div>
            {/* Mobile Phone Icon */}
            <div className="absolute top-24 right-24 animate-float-medium">
              <Phone className={`w-7 h-7 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/80' : 'text-cyber-blue/30'
              }`} />
            </div>
            {/* Wi-Fi Icon */}
            <div className="absolute top-16 right-1/3 animate-float-fast">
              <Network className={`w-6 h-6 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/75' : 'text-cyber-blue/25'
              }`} />
            </div>
            {/* Mail Icon */}
            ...
            {/* Globe Icon */}
            <div className="absolute bottom-24 right-24 animate-float-slow">
              <Globe className={`w-8 h-8 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/80' : 'text-cyber-blue/30'
              }`} />
            </div>
            {/* Home Icon */}
            <div className="absolute bottom-20 left-1/2 animate-float-medium">
              <Building2 className={`w-7 h-7 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/75' : 'text-cyber-blue/25'
              }`} />
            </div>
            {/* Document Icon */}
            <div className="absolute bottom-24 left-20 animate-float-fast">
              <FileText className={`w-6 h-6 transition-colors duration-500 ${
                theme === 'light' ? 'text-cyber-blue/80' : 'text-cyber-blue/30'
              }`} />
            </div>
            {/* Laptop Icon */}
            ...
            {/* Arrow Icons */}
            <div className="absolute bottom-16 left-1/3 animate-float-fast">
          ...
          <div className="absolute inset-0 opacity-20">
            <div className={`absolute top-0 left-0 w-full h-full bg-[linear-gradient(90deg,transparent_50%,rgba(59,130,246,0.1)_50%)] bg-[length:20px_20px] transition-opacity duration-500 ${
              theme === 'light' ? 'opacity-30' : 'opacity-15'
            }`}></div>
            <div className={`absolute top-0 left-0 w-full h-full bg-[linear-gradient(0deg,transparent_50%,rgba(59,130,246,0.1)_50%)] bg-[length:20px_20px] transition-opacity duration-500 ${
              theme === 'light' ? 'opacity-30' : 'opacity-15'
            }`}></div>
          </div>
          ...
          <div className="absolute inset-0">
            {[...Array(15)].map((_, i) => (
              <div
                key={i}
                className={`absolute w-2 h-2 rounded-full animate-glow-pulse transition-colors duration-500 ${
                  theme === 'light' ? 'bg-cyber-blue/90' : 'bg-cyber-blue/50'
                }`}
                style={{
                  top: `${Math.random() * 100}%`,
          ...
          <div className="absolute inset-0">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className={`absolute h-px bg-gradient-to-r from-transparent via-cyber-blue to-transparent animate-pulse transition-opacity duration-500 ${
                  theme === 'light' ? 'opacity-60' : 'opacity-30'
                }`}
                style={{
                  top: `${20 + i * 15}%`,
